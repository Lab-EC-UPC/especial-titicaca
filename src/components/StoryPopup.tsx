  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center px-4 md:px-10">
      ...
      >
        ...
        {/* Body */}
        <div className="font-elza text-sm md:text-xl flex flex-col gap-4 md:gap-5 px-4 lg:px-45 pb-16 md:pb-20 text-center text-white max-h-[35vh] overflow-y-auto md:max-h-none md:overflow-visible">
          <p>
