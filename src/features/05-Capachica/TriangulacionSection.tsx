        ...
        {view === "route" && (
          <>
            <div
              ...
              style={{ left: "10%", top: "38%", ...cardAnim(step >= 1) }}
            >
              <CardRoute number={1} color="#13A383" className="w-[300px]">
                Arturo salió de su pueblo natal en busca de un lugar con mayor
                acceso a la salud para tratarse. Viajó durante siete horas rumbo
                a Arequipa y así atenderse en un establecimiento de salud más
                especializado.
              </CardRoute>
            </div>
            <div
              className="absolute z-10"
              style={{ left: "73%", top: "52%", ...cardAnim(step >= 2) }}
            >
              <CardRoute number={2} color="#C03A84" className="w-[300px]">
                Regresó a Coata con un diagnóstico claro y recién pudo iniciar
                su tratamiento en San Román.
              </CardRoute>
            </div>
            <div
              className="absolute z-10"
              style={{ left: "70%", top: "23%", ...cardAnim(step >= 3) }}
            >
              <CardRoute
                number={3}
                color="#FFFFFF"
                ...
                onNext={() => setView("map")}
              >
                Ya de regreso en Coata, debía recorrer 13 kilómetros diarios
                para recibir tratamiento en una clínica privada.
              </CardRoute>
            </div>
          </>
        )}
