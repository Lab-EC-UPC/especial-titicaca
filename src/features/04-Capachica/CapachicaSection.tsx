...
export const CapachicaSection = () => {
    ...
    return (
        <section ref={sectionRef} id="capachica" className="relative isolate h-screen w-full overflow-hidden bg-black">
            <video
                ref={videoRef}
            ...
            <ScrollMessage start={0.58} end={0.72}>
                <ScrollMessage.Paragraph>
                    ...
                    cambios en el lago se reflejan en la pesca, los cultivos y la salud de las familias.
                </ScrollMessage.Paragraph>
            </ScrollMessage>
